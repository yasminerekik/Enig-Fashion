...
class articlestock7 extends StatefulWidget {
  const articlestock7({super.key});

  @override
  State<articlestock7> createState() => _articleState();
}

class _articleState extends State<articlestock7> {
  @override

...
class articlestock2 extends StatefulWidget {
  const articlestock2({super.key});

  @override
  State<articlestock2> createState() => _articleState();
}

class _articleState extends State<articlestock2> {
  @override

...
class articlestock9 extends StatefulWidget {
  const articlestock9({super.key});

  @override
  State<articlestock9> createState() => _articleState();
}

class _articleState extends State<articlestock9> {
  @override

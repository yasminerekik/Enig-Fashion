...
class articlestock1 extends StatefulWidget {
  const articlestock1({super.key});

  @override
  State<articlestock1> createState() => _articleState();
}

class _articleState extends State<articlestock1> {
  @override

...
class articlestock5 extends StatefulWidget {
  const articlestock5({super.key});

  @override
  State<articlestock5> createState() => _articleState();
}

class _articleState extends State<articlestock5> {
  @override

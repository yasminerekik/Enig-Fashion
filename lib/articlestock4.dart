...
class articlestock4 extends StatefulWidget {
  const articlestock4({super.key});

  @override
  State<articlestock4> createState() => _articleState();
}

class _articleState extends State<articlestock4> {
  @override

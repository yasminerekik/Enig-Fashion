...
class articlestock6 extends StatefulWidget {
  const articlestock6({super.key});

  @override
  State<articlestock6> createState() => _articleState();
}

class _articleState extends State<articlestock6> {
  @override

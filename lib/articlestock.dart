...
class articlestock extends StatefulWidget {
  const articlestock({super.key});

  @override
  State<articlestock> createState() => _articleState();
}

class _articleState extends State<articlestock> {
  @override

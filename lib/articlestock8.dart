...
class articlestock8 extends StatefulWidget {
  const articlestock8({super.key});

  @override
  State<articlestock8> createState() => _articleState();
}

class _articleState extends State<articlestock8> {
  @override

...
class ajouter_de_stock extends StatefulWidget {
  const ajouter_de_stock({Key? key}) : super(key: key);

  @override
  State<ajouter_de_stock> createState() => _AjouterDeStockState();
}

class _AjouterDeStockState extends State<ajouter_de_stock> {
